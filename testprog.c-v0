...
static void simd128_load(simd128 r, int *base)
{
    r[0] = base[0];
    r[1] = base[1];
    r[2] = base[2];
...
static void simd128_store(simd128 r, int *base)
{
    base[0] = r[0];
    base[1] = r[1];
    base[2] = r[2];
...
static void simd128_shift_left_word(simd128 dst, simd128 src, int v)
{
    dst[0] = v;
    dst[1] = src[0];
    dst[2] = src[1];
...
static void simd128_shift_right_word(simd128 dst, simd128 src, int v)
{
    dst[0] = src[1];
    dst[1] = src[2];
    dst[2] = src[3];
...
static void simd128_shift_right_arithmetic(simd128 dst, simd128 src, int shmnt)
{
    dst[0] = src[0] >> shmnt;
    dst[1] = src[1] >> shmnt;
    dst[2] = src[2] >> shmnt;
...
static void simd128_move(simd128 dst, simd128 src)
{
    dst[0] = src[0];
    dst[1] = src[1];
    dst[2] = src[2];
...
static void simd128_add(simd128 dst, simd128 src1, simd128 src2)
{
    dst[0] = src1[0] + src2[0];
    dst[1] = src1[1] + src2[1];
    dst[2] = src1[2] + src2[2];
...
static void simd128_mult(simd128 hi, simd128 lo, simd128 src1, simd128 src2)
{
...
int main(void) {
    ...
    for(i=0; i<(iteration/2); i++){
        ...
        for(y=1; y<n-1; y++) {
            ...
            simd128 u0, u1, u2;
            simd128 u;
            simd128 c = {0x38e38e39, 0x38e38e39, 0x38e38e39, 0x38e38e39};
            simd128 hi, lo;
